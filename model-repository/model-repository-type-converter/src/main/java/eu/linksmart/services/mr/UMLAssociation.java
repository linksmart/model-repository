...
public class UMLAssociation {
    ...
    private static final Logger LOG = Logger.getLogger(UMLAssociation.class);
...
*/
        ...
        if (node instanceof Element) {
            ...
            LOG.trace("UMLAssociation        umlID: " + umlID);
            LOG.trace("UMLAssociation stereotypeID: " + stereotypeID);
        }
        ...
        if (nList.getLength()>1){
            ...
            LOG.trace("UMLAssociation  fromClassID: " + fromClassID);
            LOG.trace("UMLAssociation    toClassID: " + toClassID);
        }
    }
