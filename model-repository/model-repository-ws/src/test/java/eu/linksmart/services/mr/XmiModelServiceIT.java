...
//    }
	...
	public void testAddXmi() throws Exception {
    	try {
    		
        	ModelRepositoryClient.initialize(URL);
        	
        	String modelName = "wuerfelstrasse";
        	
        	String xmiModelString = new String(Files.readAllBytes(Paths.get(getClass().getResource("/DeploymentWuerfel.xmi").toURI())), Charset.defaultCharset());
        	...
        	LOG.info("testAddXmi successfully completed");
        	
        } catch (Exception e) {
        	LOG.error(e.getMessage());
        	fail("testAddXmi failed: " + e.getMessage());
		}
    }
